...
const WomensCollection = () => {
 ...
 const [priceRange, setPriceRange] = useState([35, 590]);
  ...
  return (
    <div>
       <div className='h-[350px]     ml-14 mr-14  flex items-center justify-center ' style={{backgroundImage:'url("https://bonanzasatrangi.com/cdn/shop/collections/Pre-Winter-Stitched-Category-Banner_286d48dc-1e86-40e0-acff-aec96ca14e5c.jpg?v=1728110398")',backgroundRepeat:'no-repeat',backgroundSize:'100% 100%' }}>
